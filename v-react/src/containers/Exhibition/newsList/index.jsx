...
class Special extends Component {
    ...
    componentWillMount() {
        this.props.actions.getExhibition(1, 15, '区块链大会')
    }
    ...
    changePages = (page) => {
        ...
        this.props.actions.getExhibition(page, 15, '区块链大会')
    }
    ...
    render() {
        ...
        let totalCount = blockchainConvention.recordCount
