...
export default class BottomNewAuthorTitle extends Component {
    constructor(props) {
        super(props)
        this.state = {}
    }
    ...
    render() {
        ...
        const {iconUrl, nickName, newsCount, ifCollect, passportId, introduce} = this.props.authorInfo
        return <div className="new-author-title line-new-author clearfix">
            ...
            <div className="bottom-author-desc">
                <div>
                    <h5 className="title-author">{nickName || '— —'}</h5>
                    <span>&nbsp;&nbsp;文章数量&nbsp;{newsCount || 0}</span>
                </div>
